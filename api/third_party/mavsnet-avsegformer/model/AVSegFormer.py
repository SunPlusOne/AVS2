...
class MAVSNet(AVSegFormer):
    """MAVS-Net keeps AVSegFormer backbone/encoder-decoder skeleton.

    The architectural differences are injected through head configs:
    - Prompted visual query generation
    - Bidirectional fusion module between visual encoder and decoder
    """
    pass
